...
public class NetManager : MonoBehaviour
{
    ...
    /// <param name="delConnect">连接委托</param>
    ...
    public static void SendUserLogin(LoginData.LoginRet retFun, bool bForce, bool bReconnect = false)
    {
        ...
        //需要自己在五虎项目输出打断点查看
        accountInfo.SetDeviceid("242d90632219d395407238ab2aae5fcd24898ce5");
        //"242d90632219d395407238ab2aae5fcd24898ce5"
        accountInfo.SetDevicetype("Desktop_兰化彤的电脑");
        //"Desktop_兰化彤的电脑"
        accountInfo.SetDeviceversion("OpenGL ES 2.0 [emulated]");
        //"OpenGL ES 2.0 [emulated]"
        accountInfo.SetAccount("242d900");
        //"242d900"
