...
namespace SPacket.SocketInstance
{
    ...
    public class GC_UPDATE_FELLOWHandler : Ipacket
    {
        public uint Execute(PacketDistributed ipacket)
        {
            ...
            FellowContainer container = PlayerDataManager.Instance.FellowContainer;//GameManager.gameManager.PlayerDataPool.FellowContainer;
            if (container != null)
            {
                ...
                ServerReceiveManager.Instance.AddFellowData(fellow);
                Debug.Log("侍从数据" + fellow.Name + "DataID::" + fellow.DataId);
                //MessageCenter.Instance.OnBroadCast(MsgID.ReceiveServerFellowAttr, fellow);
